...
| **La chaîne de cellules : des capsules abstraites, pas de petits neurones** | Décision de l'utilisateur le 11 septembre 2026, entre trois options présentées avec leur coût. Le trait bleu, devenu bande par la plongée de la caméra, se révèle fait de formes allongées mises bout à bout ; l'une s'isole, puis le neurone se dessine à sa place. Des petits neurones dans la chaîne auraient montré la chose avant de la nommer, ce que l'ordre des mots de `02-CONTENU.md` interdit |
